                ...
                <table className='w-full opacity-70 table-auto text-center'>
                    <thead>
                        <tr className='border-t border-b'>
                            ...
                            <th className='p-1 pl-8'>Trip</th>
                            <th className='p-1 pl-8'>Inv. Date</th>
                            <th className='p-1 pl-8'>Inv. Amount</th>
                            <th className='p-1 pl-8'>Bal. Due</th>
                            <th className='p-1 pl-8'>Payment Method</th>
                            <th className='p-1 pl-8'>Due Date</th>
                            <th className='p-1 pl-8'>Status</th>
                            <th className='p-1 pl-8 pr-11'>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        {
                            invoicesData.map(({ id, invoiceNo, date, amount, dueDate, dueAmount, paymentMethod, trip, status }) => <tr key={id}>
                                ...
                                <td className='p-1 pl-8'>{trip}</td>
                                <td className='p-1 pl-8'>{date}</td>
                                <td className='p-1 pl-8'>{amount}</td>
                                <td className='p-1 pl-8'>{dueAmount}</td>
                                <td className='p-1 pl-8'>{paymentMethod}</td>
                                <td className='p-1 pl-8'>{dueDate}</td>
                                <td className='p-1 pl-8'>{status}</td>
                                <td className='p-1 pl-8 pr-11 flex gap-2'>
