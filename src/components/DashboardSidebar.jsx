        ...
        <div className=' bg-primary rounded-r-xl text-white'>
            <div>
                ...
                <div className='overflow-y-auto max-h-[562px] scroll'>
                    {
                        sidebarData.map(({ id, title, path, img }) => <Link key={id} to={path} className='flex items-center ml-11 py-4 opacity-50 hover:opacity-100 px-2 hover:bg-[#534aff]  hover:rounded-s-3xl'>
